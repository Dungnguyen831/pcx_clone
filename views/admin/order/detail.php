<div class="table-container">
    ...
    <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 25px;">
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
            <h3 style="margin-top: 0; color: #2563eb; border-bottom: 2px solid #fff; padding-bottom: 10px;">
            ...
            <div style="line-height: 1.8; margin-top: 15px;">
                ...
                <p style="font-size: 20px; font-weight: 800; color: #2563eb;">Thanh toán: <?= number_format($order['final_money'], 0, ',', '.') ?>đ</p>
            </div>
        </div>
